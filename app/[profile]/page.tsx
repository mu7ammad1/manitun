      ...
      <div className="max-w-[500px] ">
        <div className="">
          ...
          <p className="text-sm font-normal text-left pt-4 px-2 max-lg:text-center">
            ...
            Google Certified Associate Cloud Engineer. A Data Analytics at Acme,
            specializing in the use of cloud infrastructure for Machine Learning
            and Deep Learning operation at scale.
          </p>
        </div>
      </div>
    </div>
