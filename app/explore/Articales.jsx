...
function MyComponent() {
  ...
  return (
    <div>
      ...
      <h1 className="text-4xl text-center font-semibold my-12">استكشف شغفك </h1>
      ...
      {data !== null ? (
        <div className="col-span-2 h-full space-y-2">
          ...
          {data.length > 0 && (
            <>
              {data.map((article, id) => (
                <div key={id} className="outline-4 outline-blue-500">
                        ...
                        <div className="basis-full px-5">
                          ...
                          <div className="flex justify-end items-center gap-5">
                            ...
                            <div className="flex gap-3 justify-center items-center">
                              ...
                              <Link href={article.authorId}>
                                <img src={article.image} alt="name" className="w-5 h-5 rounded-full" />
                              </Link>
                            </div>
                          </div>
                        </div>
